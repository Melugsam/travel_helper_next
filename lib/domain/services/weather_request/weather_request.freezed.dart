...
abstract class $WeatherRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String cod, List<WeatherData> list});
}
...
class _$WeatherRequestImpl implements _WeatherRequest {
  const _$WeatherRequestImpl(
      {required this.cod, required final List<WeatherData> list})
      : _list = list;
  ...
  @override
  String toString() {
    return 'WeatherRequest(cod: $cod, list: $list)';
  }
...
abstract class _WeatherRequest implements WeatherRequest {
  const factory _WeatherRequest(
      ...
      required final List<WeatherData> list}) = _$WeatherRequestImpl;
